...
plot(fl$Global_active_power~fl$DateTime, type="l", ylab="Global Active Power",
     xlab="")

plot(fl$Voltage~fl$DateTime, type="l", ylab="Voltage", xlab="datetime")
...
plot(fl$Global_reactive_power~fl$DateTime, type="l", 
